...
def error404(e):
    ...
    return render_template("error.jinja", err="404 Not Found!!", msg=message)
...
def error403(e):
    ...
    return render_template('error.jinja', err='403 Forbidden', msg=message)
...
def error500(e):
    ...
    return render_template('error.jinja', err="500 Internal Server Error", msg=message)
...
def error413(e):
    ...
    return render_template('error.jinja', err='413 Payload too large', msg=message)
...
def error409(e):
     ...
     return render_template('error.jinja', err="409 Conflict", msg=message)
...
def error400(e):
    ...
    return render_template('error.jinja', err='400 Bad Request', msg=message)